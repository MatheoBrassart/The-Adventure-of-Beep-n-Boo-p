...
var DIALOGUE_LIST: Dictionary = {
	...
	"BeepReveilWalkthrough" = {
		...
		"4" = {"Character": "Le créateur", "Message": "Peut-être que se sera un peu long ou un peu court, tout dépend du skill du testeur, on verra bien.", "face": "leCreateur"},
		"5" = {"Character": "Le créateur", "Message": "Sur ce, que l'aventure commence !", "face": "leCreateur"},
		"6" = {"Character": "Beep", "Message": "Ah ok.", "face": "beepNeutral"},
		"7" = {"Character": "Boop", "Message": "Bon bah aller, bouge !", "face": "boopBored"},
	},
	"FinDemo4" = {
		"0" = {"Character": "Le créateur", "Message": "Eeeet ce walkthrough est donc terminé, gg !", "face": "leCreateur"},
